...
public class SerchfriendsActivity extends BaseActivity<FriendsPresenter> implements View.OnClickListener,FriendsContract.view  {
    ...
    public int getContentLayout() {
        return R.layout.activity_serchfriends;
    }
    ...
    public void initView() {
        ...
        String uid = (String) SharedPreferencesUtils.getParam(SerchfriendsActivity.this, "uid", "-1");
        String token = (String) SharedPreferencesUtils.getParam(SerchfriendsActivity.this, "token", "");
    ...
    public void randomFriends(FriendsBean friendsBean) {
        Toast.makeText(SerchfriendsActivity.this,"获取成功",Toast.LENGTH_SHORT).show();
        List<FriendsBean.DataBean> data = friendsBean.getData();
        FriendsAdapter friendsAdapter = new FriendsAdapter(SerchfriendsActivity.this,data);
